 ...
 * Uses a pattern unlikely to conflict with user code.
 */
 ...
 *
 * Uses a namespace import with a mangled name to avoid polluting
 * the module scope with identifiers that could conflict with user code.
 *
...
export function generateInjections(
  ...
  const lines: string[] = [
    ...
    `import type * as ${ACP_NAMESPACE} from "@thinkwell/acp";`,
    "",
  ];
