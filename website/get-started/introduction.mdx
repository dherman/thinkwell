...
Thinkwell uses the [Agent Client Protocol (ACP)](https://github.com/anthropics/agent-client-protocol) to connect to AI agents like Claude Code, Codex, Gemini CLI, and others. This means you write one script and can run it against different AI backends.
